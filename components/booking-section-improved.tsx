...
export function BookingSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        toast("💅 Check your email for confirmation details!", {
          duration: 5000,
          style: {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-pink-200 mb-6">
            ...
            <span className="text-hot-pink font-medium text-sm">⚡ Quick 5-Minute Booking</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-2xl">
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-sm text-gray-600 mt-2">🔥 17 Appointments Booked Today</p>
            </CardHeader>
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-sm font-medium text-gray-700">
                      Phone Number * <span className="text-xs text-gray-500">📱 Text Reminders Available</span>
                    </Label>
                    <div className="relative">
                ...
                <Button
                  ...
                  className="w-full gradient-hot-pink text-white hover:opacity-90 transition-all duration-300 disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className="space-y-8">
            ...
            <div className="text-center space-y-2">
              <p className="text-sm text-gray-600">💅 Serving 500+ Happy Clients Monthly</p>
              <p className="text-sm text-gray-600">♿ Wheelchair Accessible</p>
              <p className="text-sm text-gray-600">💯 100% Sanitized Tools</p>
            </div>
          </div>
        </div>
      </div>
