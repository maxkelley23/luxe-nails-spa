      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-pink-200 mb-6">
            ...
            <span className="text-hot-pink font-medium text-sm">Transparent Pricing</span>
          </div>
          ...
          {pricingTiers.map((tier, index) => (
            ...
            >
              ...
              <CardContent className="px-6 pb-8">
                ...
                <Button
                  size="lg"
                  className={`w-full ${tier.buttonStyle} text-white hover:opacity-90 transition-opacity`}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <Card className="bg-gradient-to-r from-purple-600 to-pink-500 text-white">
              <CardContent className="p-6">
                ...
                <Badge className="bg-white/20 text-white">VIP Members</Badge>
              </CardContent>
            </Card>
          </div>
        </div>
