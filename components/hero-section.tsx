    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          {/* Announcement Bar */}
          <div className="inline-flex items-center px-6 py-2 rounded-full bg-gold/20 backdrop-blur-sm border border-gold/30 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button
              size="lg"
              className="gradient-hot-pink text-white text-lg px-8 py-4 hover:opacity-90 transition-opacity"
            >
